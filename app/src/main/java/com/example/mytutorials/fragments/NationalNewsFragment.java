...
import com.example.mytutorials.NationalDetailActivity;
...
public class NationalNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headlinesRecycler.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), headlinesRecycler, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(getContext(), NationalDetailActivity.class);
                intent.putExtra(NationalDetailActivity.EXTRA_HEADLINE_ID, position);
    ...
    private void prepareHeadlinesData() {
        NewsData newsData = new NewsData("National1", R.drawable.national);
        newsDataList.add(newsData);

        newsData = new NewsData("National2", R.drawable.national);
        newsDataList.add(newsData);
