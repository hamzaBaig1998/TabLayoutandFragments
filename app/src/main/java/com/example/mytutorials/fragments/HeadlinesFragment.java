...
public class HeadlinesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headlinesRecycler.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), headlinesRecycler, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(getContext(), HeadlinesDetailActivity.class);
                intent.putExtra(HeadlinesDetailActivity.EXTRA_HEADLINE_ID, position);
    ...
    private void prepareHeadlinesData() {
        NewsData newsData = new NewsData("Headline1", R.drawable.national);
        newsDataList.add(newsData);

        newsData = new NewsData("Headline2", R.drawable.international);
        newsDataList.add(newsData);
