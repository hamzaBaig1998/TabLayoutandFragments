...
import com.example.mytutorials.InternationalDetailActivity;
...
public class InternationalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headlinesRecycler.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), headlinesRecycler, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(getContext(), InternationalDetailActivity.class);
                intent.putExtra(InternationalDetailActivity.EXTRA_HEADLINE_ID, position);
    ...
    private void prepareHeadlinesData() {
        NewsData newsData = new NewsData("International_1", R.drawable.international);
        newsDataList.add(newsData);

        newsData = new NewsData("International_2", R.drawable.international);
        newsDataList.add(newsData);
